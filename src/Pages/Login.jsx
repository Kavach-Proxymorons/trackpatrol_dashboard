    ...
    <>
      <div className="h-screen flex ">
        <div className="w-1/2 bg-[#F4F6FA]">
          ...
          <div className="flex flex-col justify-between items-center drop-shadow h-auto">
            <img className="w-[350px]" src={image} alt="image" />

            {/* caption */}
            <div className="mt-28 mx-32 drop-shadow">
        ...
        <div className="ml-8 w-7/12  flex flex-col justify-center items-center drop-shadow">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <input
              name="username"
              className="border-none bg-[#F4F6FA] rounded-lg pl-8 pr-32 py-4 mt-2 "
              type="text"
            ...
            <div className="relative">
              <input
                name="password"
                className="border-none bg-[#F4F6FA] rounded-lg mt-2 pl-8 pr-32 py-4"
                type="password"
                placeholder="Password"
              />
              <div
                className="absolute right-0 bottom-4 mt-8 mr-8"
